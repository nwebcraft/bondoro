...
- [ ] 1.1 Ruby 3.2+ プロジェクト初期化（Gemfile作成）
- [ ] 1.2 AWS SAM テンプレート (`template.yaml`) 作成
- [ ] 1.3 ディレクトリ構成作成
- [ ] 1.4 RSpec設定
- [ ] 1.5 .env.example と環境変数設計

## 2. DynamoDB テーブル設計・構築

- [ ] 2.1 Productsテーブル定義（SAMテンプレート）
- [ ] 2.2 Usersテーブル定義（SAMテンプレート）
- [ ] 2.3 GSI設計（notified商品取得用）
...
- [ ] 8.1 LINE Developersコンソールでチャネル作成
- [ ] 8.2 Messaging API設定
- [ ] 8.3 Webhook URL設定
- [ ] 8.4 リッチメニュー設定（任意）
